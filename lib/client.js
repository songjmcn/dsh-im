...
// src/channels/weixin/connection-error.en.mjs
...
var EN = Object.freeze({
  ...
  "\u7FA4\u804A\u4EE5\u8BDD\u9898\u65B9\u5F0F\u56DE\u590D": "Reply to group chats as Feishu topics",
  "\u7FA4\u804A\u4EE5\u8BDD\u9898\u65B9\u5F0F\u56DE\u590D\u8BBE\u7F6E\u4FDD\u5B58\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5\u3002": "Could not save the topic reply setting. Try again.",
  "\u5173\u95ED\uFF08\u7FA4\u5185\u76F4\u63A5\u56DE\u590D\uFF09": "Off (reply in the group feed)",
  ...
  "\u67E5\u770B\u4F1A\u8BDD\u76EE\u5F55\u9694\u79BB\u8BF4\u660E": "View conversation directory help",
  "\u67E5\u770B\u5DE5\u4F5C\u533A\u9694\u79BB\u8BF4\u660E": "View workspace isolation help",
  "\u5DF2\u5F00\u542F\u4F1A\u8BDD\u76EE\u5F55\u9694\u79BB\uFF0C\u5DE5\u4F5C\u533A\u7531\u5BF9\u8BDD\u81EA\u52A8\u6D3E\u751F\uFF0C\u65E0\u6CD5\u624B\u52A8\u4FEE\u6539\u3002": "Conversation directory isolation is on. The workspace is derived automatically from the conversation and cannot be changed manually.",
  ...
  "\u6A21\u578B\u65E0\u6548\u3002": "The model is invalid.",
  "\u6A21\u578B\u4E0D\u5B58\u5728\u6216\u4E0D\u53EF\u7528\u3002": "The model does not exist or is unavailable.",
  "\u5F53\u524D\u6A21\u578B\u5DF2\u4E0D\u53EF\u7528\uFF0C\u8BF7\u9009\u62E9\u5176\u4ED6\u6A21\u578B\u6216\u8DDF\u968F\u9ED8\u8BA4\u6A21\u578B\u3002": "The current model is unavailable. Choose another model or follow the default.",
  ...
  "\u7FA4\u804A\u8BBE\u7F6E": "Group settings",
  "\u5F53\u524D\u673A\u5668\u4EBA": "Current bot",
  "\u98DE\u4E66\u7FA4\u804A\u8BBE\u7F6E\u6682\u4E0D\u53EF\u7528\u3002": "Feishu group settings are currently unavailable.",
  "\u98DE\u4E66\u670D\u52A1\u6CA1\u6709\u8FD4\u56DE\u5F53\u524D\u673A\u5668\u4EBA\u7684\u8BBE\u7F6E": "Feishu did not return settings for this bot",
  ...
  "\u6B63\u5728\u5220\u9664\u2026": "Deleting\u2026",
  "\u786E\u8BA4\u5220\u9664": "Delete target",
  "\u4F1A\u8BDD\u53CC\u5411\u540C\u6B65": "Two-way Session sync",
  "\u81EA\u52A8\u8DDF\u968F\u8BE5\u79C1\u804A\u7684\u5F53\u524D\u4F1A\u8BDD": "Automatically follow this direct message\u2019s current Session",
  "\u7B49\u5F85\u8BE5\u79C1\u804A\u5EFA\u7ACB\u65B0\u4F1A\u8BDD": "Waiting for this direct message to establish a new Session",
  "\u5173\u95ED\u65F6\u4E0D\u53D1\u9001 DSH \u4F1A\u8BDD\u6D88\u606F": "DSH Session messages are not sent while disabled",
  "\u4EC5\u652F\u6301\u5DF2\u7ECF\u804A\u8FC7\u3001\u5DF2\u5EFA\u7ACB\u5F53\u524D\u4F1A\u8BDD\u4E14\u4F7F\u7528\u5F53\u524D Host Harness \u7684\u79C1\u804A\u76EE\u6807": "Only a known direct message with a current Session on this Host Harness is supported",
  "\u4F1A\u8BDD\u540C\u6B65\u4EC5\u652F\u6301\u5DF2\u7ECF\u804A\u8FC7\u3001\u5DF2\u5EFA\u7ACB\u5F53\u524D\u4F1A\u8BDD\u4E14\u4F7F\u7528\u5F53\u524D Host Harness \u7684\u79C1\u804A\u76EE\u6807\u3002": "Session sync requires a known direct message with a current Session on this Host Harness.",
  "\u4F1A\u8BDD\u540C\u6B65\u8BBE\u7F6E\u5931\u8D25\uFF0C\u8BF7\u7A0D\u540E\u91CD\u8BD5\u3002": "Could not update Session sync. Try again later.",
  "\u4FEE\u6539\u63A5\u6536\u4F4D\u7F6E\u4F1A\u5173\u95ED\u4F1A\u8BDD\u53CC\u5411\u540C\u6B65\u3002": "Changing the destination disables two-way Session sync.",
  ...
  "\u901A\u7528\u8BBE\u7F6E\u5206\u7C7B": "General settings categories",
  "\u9644\u4EF6": "Attachments",
  "IM \u8BBE\u7F6E\u5BFC\u822A": "IM settings navigation",
  "\u9644\u4EF6\u4FDD\u7559\u65F6\u957F (\u5C0F\u65F6)": "Attachment retention (hours)",
  "\u67E5\u770B\u9644\u4EF6\u4FDD\u7559\u65F6\u957F\u8BF4\u660E": "View attachment retention details",
  ...
  "\u901A\u7528\u8BBE\u7F6E\u8FD4\u56DE\u4E86\u65E0\u6CD5\u8BC6\u522B\u7684\u54CD\u5E94\u3002": "General settings returned an unrecognized response.",
...
var EMPTY_MODEL_CATALOG = Object.freeze({
...
// src/channels/shared/conversation-directory.mjs
var CONVERSATION_DIRECTORY_PREFIX = "conv-";
var CONVERSATION_DIRECTORY_STRATEGIES = Object.freeze([
  "per-conversation",
  "per-session"
]);
var DEFAULT_CONVERSATION_DIRECTORY_SETTINGS = Object.freeze({
  enabled: false,
  strategy: "per-conversation",
  prefix: CONVERSATION_DIRECTORY_PREFIX
});
var SETTINGS_KEYS = ["enabled", "strategy", "prefix"];
var PREFIX_PATTERN = /^[A-Za-z0-9_-]{1,32}$/;
function invalidSettings(message) {
  const error = new TypeError(message);
  error.code = "conversation-directory-invalid";
  return error;
}
function hasExactKeys3(input, keys, { allowMissing = [] } = {}) {
...
function validateConversationDirectorySettings(value) {
  if (!hasExactKeys3(value, SETTINGS_KEYS, { allowMissing: ["strategy", "prefix"] })) {
  ...
  const strategy = Object.hasOwn(value, "strategy") ? value.strategy : DEFAULT_CONVERSATION_DIRECTORY_SETTINGS.strategy;
  if (!CONVERSATION_DIRECTORY_STRATEGIES.includes(strategy)) {
    throw invalidSettings("\u4F1A\u8BDD\u76EE\u5F55\u7B56\u7565\u53EA\u80FD\u662F per-conversation \u6216 per-session\u3002");
  }
  const prefix = Object.hasOwn(value, "prefix") ? value.prefix : CONVERSATION_DIRECTORY_PREFIX;
...
function normalizeConversationDirectorySettings(value) {
  try {
...
function normalizeBot(value) {
  ...
  return {
    ...
    ...Object.hasOwn(value, "conversationDirectory") ? { conversationDirectory: normalizeConversationDirectorySettings(value.conversationDirectory) } : {},
...
function WorkspaceEditor({
  ...
  return h2(
    ...
    h2(
      ...
      h2(
        "span",
        { className: "dim-workspaceTitle" },
        h2("span", null, "\u5F53\u524D\u5DE5\u4F5C\u533A"),
        directoryIsolation ? h2(
          "span",
          { className: "dim-workspaceHelp" },
          h2("button", {
            type: "button",
          ...
          h2("span", { id: helpId, className: "dim-workspaceTooltip", role: "tooltip" }, "\u5DF2\u5F00\u542F\u4F1A\u8BDD\u76EE\u5F55\u9694\u79BB\uFF0C\u5DE5\u4F5C\u533A\u7531\u5BF9\u8BDD\u81EA\u52A8\u6D3E\u751F\uFF0C\u65E0\u6CD5\u624B\u52A8\u4FEE\u6539\u3002")
        ) : null
      ),
      h2("button", {
        type: "button",
...
// plugin-src/client/conversation-directory.js
var React14 = __toESM(require("react"), 1);
var STRATEGY_LABELS = Object.freeze({
  "per-conversation": "\u6BCF\u5BF9\u8BDD\u4E00\u4E2A\u76EE\u5F55",
  "per-session": "\u6BCF\u4F1A\u8BDD\u4E00\u4E2A\u76EE\u5F55"
});
var SCOPE_TITLES = Object.freeze({
  bot: "\u4F1A\u8BDD\u76EE\u5F55\u9694\u79BB",
  channel: "\u6E20\u9053\u9ED8\u8BA4 \xB7 \u4F1A\u8BDD\u76EE\u5F55\u9694\u79BB"
});
function ConversationDirectoryEditor({
  config,
  scope = "bot",
  hasOverride = true,
  disabled = false,
  ...
  const [enabled, setEnabled] = React14.useState(settings.enabled);
  const [strategy, setStrategy] = React14.useState(settings.strategy);
  const [prefix, setPrefix] = React14.useState(settings.prefix);
  const [saving, setSaving] = React14.useState(false);
  ...
  const save = React14.useCallback(async (next) => {
    const payload = {
  ...
  const clear = React14.useCallback(async () => {
  ...
  const helpId = React14.useId();
  const helpText = scope === "channel" ? "\u5F71\u54CD\u672C\u6E20\u9053\u5168\u90E8\u65E0\u8986\u76D6\u7684\u673A\u5668\u4EBA\u3002\u5F00\u542F\u540E /workspace\u3001/conv \u4E0E\u624B\u52A8\u6539\u5DE5\u4F5C\u533A\u4E0D\u53EF\u7528\u3002" : "\u5F00\u542F\u540E\u5DE5\u4F5C\u76EE\u5F55\u6309\u5BF9\u8BDD\u81EA\u52A8\u6D3E\u751F\uFF1B/workspace\u3001/conv \u4E0E\u624B\u52A8\u6539\u5DE5\u4F5C\u533A\u4E0D\u53EF\u7528\uFF1B/session \u4EC5\u53EF\u7ED1\u5B9A\u672C\u76EE\u5F55\u5185\u4F1A\u8BDD\u3002";
  return h2(
    "div",
    {
    ...
    h2(
      "div",
      { className: "dim-conversationDirectoryHeader" },
      h2(
        "span",
        { className: "dim-conversationDirectoryTitle" },
        h2("span", null, title),
        h2(
          "span",
          { className: "dim-conversationDirectoryHelp" },
          h2("button", {
            type: "button",
          ...
          h2("span", { id: helpId, className: "dim-conversationDirectoryTooltip", role: "tooltip" }, helpText)
        )
      ),
      h2(
        "label",
        { className: "dim-contextSwitchRow" },
        h2("span", { className: "dim-contextSwitchLabel" }, enabled ? "\u5DF2\u5F00\u542F" : "\u5DF2\u5173\u95ED"),
        h2("input", {
          type: "checkbox",
          role: "switch",
          className: "dim-contextSwitch",
    ...
    scope === "bot" && !hasOverride ? h2("div", { className: "dim-summary" }, "\u672A\u8986\u76D6 \xB7 \u5F53\u524D\u7EE7\u627F\u6E20\u9053\u9ED8\u8BA4\uFF1B\u6253\u5F00\u5F00\u5173\u53EF\u5355\u72EC\u4E3A\u672C\u673A\u5668\u4EBA\u8986\u76D6\u3002") : null,
    showFields ? h2(
      "div",
      { className: "dim-conversationDirectoryFields" },
      h2(
        "label",
        { className: "dim-conversationDirectoryField" },
        h2("span", null, "\u7B56\u7565"),
        h2("select", {
          value: strategy,
          disabled: busy,
        ...
        }, CONVERSATION_DIRECTORY_STRATEGIES.map((value) => h2("option", {
          key: value,
          value
    ...
    showClear ? h2(
      "div",
      { className: "dim-conversationDirectoryActions" },
      h2("button", {
        type: "button",
        className: "dim-workspaceEdit",
        disabled: busy,
    ...
    error ? h2("div", { className: "dim-summary dim-cardFeedback", role: "alert" }, error) : null
  );
}

// plugin-src/client/channels/shared/token-channel.js
var Button3 = React15.forwardRef(function Button4({ children, kind = "secondary", className = "", ...props }, ref) {
  return h2("button", {
    ...props,
    ref,
    type: "button",
...
function createTokenChannelSettings(definition) {
  ...
  function AccountCard6({ account, busy, testNotice, removing, onReconnect, onWorkspaceSave, onAliasSave, onModelSave, onAgentPresetSave, onContextEnhancementSave, onConversationDirectorySave, onAccountSettingsSave, onRequestRemove, onConfirmRemove, onCancelRemove }) {
    const state = busy === "reconnect" ? "connecting" : account.state;
    const tone = account.connected ? "success" : state === "error" ? "error" : "warning";
    const stateLabel2 = account.connected ? "\u8FD0\u884C\u6B63\u5E38" : state === "connecting" ? "\u6B63\u5728\u8FDE\u63A5" : "\u8FDE\u63A5\u672A\u5C31\u7EEA";
    const summary2 = account.error?.message ?? (account.connected ? null : account.health.summary);
    ...
    return h2(
      ...
      h2(
        ...
        h2(
          ...
          h2(ConversationDirectoryEditor, {
  ...
  function SettingsTab({ rpcCall }) {
    ...
    const loadStatus = React15.useCallback(async ({ signal, silent = false } = {}) => {
      const workspaceVersion = workspaceFence.beginStatus();
    ...
    const bindCredentials = React15.useCallback(async (values) => {
      const snapshotVersion = workspaceFence.beginMutation();
      setBusy(true);
      setCredentialError(null);
      try {
    ...
    const botList = model.bots.length > 0 ? h2(
      ...
      h2("ul", { className: "ddt-list dim-botList" }, model.bots.map((account) => h2("li", { key: account.botId }, h2(AccountCard6, {
        ...
        onConversationDirectorySave: endpoints.setConversationDirectory ? (config) => botAction(
          account,
...
function useAnimationFrameScheduler() {
  const schedulerRef = React16.useRef(null);
  React16.useEffect(() => {
...
var Button5 = React17.forwardRef(function Button6({ children, kind = "secondary", size, icon, className = "", ...props }, ref) {
  return h2("button", {
    ...props,
    ref,
    type: "button",
...
function QrPane({ provision, now, onRefresh, onCancel, busy }) {
  ...
  React17.useEffect(() => setImageFailed(false), [qrSource]);
  return h2(
    "div",
...
function RemoveConfirmation2({ bot, busy, onConfirm, onCancel }) {
  ...
  React17.useEffect(() => cancelRef.current?.focus(), []);
  return h2(
    "div",
    {
...
function StepPushEditor({ value = false, mode = "post", disabled = false, onSave, onModeSave }) {
  ...
  const [saving, setSaving] = React17.useState(false);
...
function BotCard({
  ...
  const repairTooltipId = React17.useId();
...
function mergeFeishuSnapshotState(current, snapshot, { restoreProvisioning = false, now = Date.now() } = {}) {
  ...
  return {
    ...
    ...Object.hasOwn(snapshot, "conversationDirectoryDefault") ? { conversationDirectoryDefault: snapshot.conversationDirectoryDefault } : { conversationDirectoryDefault: void 0 }
  };
}
function FeishuSettingsTab({ rpcCall }) {
  ...
  const [pageBusy, setPageBusy] = React17.useState(false);
  const [provisionBusy, setProvisionBusy] = React17.useState(false);
  const [credentialOpen, setCredentialOpen] = React17.useState(false);
  const [credentialBusy, setCredentialBusy] = React17.useState(false);
  const [credentialError, setCredentialError] = React17.useState(null);
  const [busyByBot, setBusyByBot] = React17.useState({});
  const [errorsByBot, setErrorsByBot] = React17.useState({});
  const [testNoticesByBot, setTestNoticesByBot] = React17.useState({});
  const [removeTargetId, setRemoveTargetId] = React17.useState(null);
  const [announcement, setAnnouncement] = React17.useState("");
  const [now, setNow] = React17.useState(() => Date.now());
  const [focusBotId, setFocusBotId] = React17.useState(null);
  const cardRefs = React17.useRef(/* @__PURE__ */ new Map());
  const removeButtonRefs = React17.useRef(/* @__PURE__ */ new Map());
  const targetedProvisionRef = React17.useRef(null);
  ...
  const mergeSnapshot = React17.useCallback((snapshot, { restoreProvisioning = false } = {}) => {
    const now2 = Date.now();
  ...
  const loadStatus = React17.useCallback(async ({ signal, silent = false, restoreProvisioning = false } = {}) => {
    const workspaceVersion = workspaceFence.beginStatus();
  ...
  const startProvisioning = React17.useCallback(async ({
    replace = false,
  ...
  const setBotError = React17.useCallback((botId, error) => {
  ...
  const repairCallback = React17.useCallback((connection) => {
  ...
  const reconnectOneBot = React17.useCallback(async (connection) => {
  ...
  const saveWorkspace = React17.useCallback(async (connection, workspace) => {
  ...
  const saveBotSetting = React17.useCallback(async (connection, operation, endpoint, payload) => {
    const { botId } = connection;
    const snapshotVersion = workspaceFence.beginMutation();
  ...
  const [channelDirectoryBusy, setChannelDirectoryBusy] = React17.useState(false);
  const saveChannelConversationDirectory = React17.useCallback(async (config) => {
    const snapshotVersion = workspaceFence.beginMutation();
  ...
  const requestRemove = React17.useCallback((connection) => {
    setRemoveTargetId(connection.botId);
  }, []);
  const cancelRemove = React17.useCallback(() => {
  ...
  const confirmRemove = React17.useCallback(async (connection) => {
    const { botId, bot } = connection;
    const snapshotVersion = workspaceFence.beginMutation();
  ...
  const setCardRef = React17.useCallback((botId, node) => {
    if (node) cardRefs.current.set(botId, node);
    else cardRefs.current.delete(botId);
  }, []);
  const setRemoveButtonRef = React17.useCallback((botId, node) => {
      ...
      model.bots.length > 0 ? h2(
        ...
        h2(BotList, {
          ...
          onConversationDirectorySave: (connection, config) => saveBotSetting(
            connection,
            "conversation-directory",
            FEISHU_ENDPOINTS.setConversationDirectory,
            { config }
          ),
...
var Button7 = React18.forwardRef(function Button8({ children, kind = "secondary", className = "", ...props }, ref) {
  return h2("button", {
    ...props,
    ref,
    type: "button",
...
function OfficeSettingsTab({ rpcCall, initialStatus }) {
  const [model, setModel] = React19.useState(normalizeOfficeStatus(initialStatus));
  const [phase, setPhase] = React19.useState(initialStatus === void 0 ? "loading" : "ready");
  const [busy, setBusy] = React19.useState("");
  ...
  const load = React19.useCallback(async () => {
    try {
...
function SlackCredentialPanel({ busy, error, onSubmit, onCancel }) {
  const [botToken, setBotToken] = React20.useState("");
  const [appToken, setAppToken] = React20.useState("");
...
var Button10 = React21.forwardRef(function Button11({ children, kind = "secondary", className = "", ...props }, ref) {
  return h2("button", {
    ...props,
    ref,
    type: "button",
...
function WecomSettingsTab({ rpcCall }) {
  ...
  const [credentialOpen, setCredentialOpen] = React21.useState(false);
  const [credentialError, setCredentialError] = React21.useState(null);
  ...
  const bindCredentials = React21.useCallback(async ({ identity, secret }) => {
    const snapshotVersion = workspaceFence.beginMutation();
    setBusy(true);
    setCredentialError(null);
    try {
...
// plugin-src/client/channels/wecom-app/index.js
var Button12 = React22.forwardRef(function Button13({ children, kind = "secondary", className = "", ...props }, ref) {
  return h2("button", {
    ...props,
    ref,
    type: "button",
...
function BindForm({ busy, error, onSubmit, onCancel }) {
  const [corpId, setCorpId] = React22.useState("");
  const [agentId, setAgentId] = React22.useState("");
  const [secret, setSecret] = React22.useState("");
  const [token, setToken] = React22.useState("");
  const [aesKey, setAesKey] = React22.useState("");
  const [apiBaseUrl, setApiBaseUrl] = React22.useState("");
  const [callbackBaseUrl, setCallbackBaseUrl] = React22.useState("");
  const [streamEnabled, setStreamEnabled] = React22.useState(true);
  const headingId = React22.useId();
  const formRef = React22.useRef(null);
  const submit = (event) => {
    event.preventDefault();
    if (busy) return;
    void onSubmit?.({
...
function AppSettingsEditor({ bot, busy, onSave }) {
  const [apiBaseUrl, setApiBaseUrl] = React22.useState(bot.apiBaseUrl ?? "");
  const [callbackBaseUrl, setCallbackBaseUrl] = React22.useState(bot.callbackBaseUrl ?? "");
  const [streamEnabled, setStreamEnabled] = React22.useState(bot.streamEnabled !== false);
  const [dirty, setDirty] = React22.useState(false);
  const formRef = React22.useRef(null);
  React22.useEffect(() => {
...
function WecomAppSettingsTab({ rpcCall }) {
  ...
  const [bindOpen, setBindOpen] = React22.useState(false);
  const [bindError, setBindError] = React22.useState(null);
  ...
  const noticeFrameRef = React22.useRef(null);
  const announce = React22.useCallback((message) => {
    if (!mounted.current) return;
    if (noticeFrameRef.current !== null) {
      window.cancelAnimationFrame(noticeFrameRef.current);
      noticeFrameRef.current = null;
  ...
  const bindApp = React22.useCallback(async (payload) => {
    const snapshotVersion = workspaceFence.beginMutation();
    setBusy(true);
    setBindError(null);
    try {
...
// plugin-src/client/channels/weixin/connection-error.js
var React23 = __toESM(require("react"), 1);

// src/channels/weixin/diagnostic-details.mjs
...
var RESOURCES = /* @__PURE__ */ new Set(["credential-store", "account-config", "account-state", "workspace-config", "workspace-directory"]);
function normalizeWeixinDiagnosticDetails(value) {
  ...
  if (typeof value.occurredAt === "string" && /^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d\.\d{3}Z$/.test(value.occurredAt) && Number.isFinite(Date.parse(value.occurredAt))) result.occurredAt = value.occurredAt;
  if (Number.isInteger(value.httpStatus) && value.httpStatus >= 100 && value.httpStatus <= 599) result.httpStatus = value.httpStatus;
  const provider = typeof value.providerCode === "number" && Number.isSafeInteger(value.providerCode) ? String(value.providerCode) : value.providerCode;
  if (typeof provider === "string" && /^-?\d{1,12}$/.test(provider)) result.providerCode = provider;
  if (typeof value.pluginVersion === "string" && /^\d+\.\d+\.\d+(?:-[A-Za-z0-9.-]+)?$/.test(value.pluginVersion) && value.pluginVersion.length <= 64) result.pluginVersion = value.pluginVersion;
...
function normalizeConnectionError(value, fallbackCode = "WEIXIN_ERROR", fallbackMessage = "\u5FAE\u4FE1\u64CD\u4F5C\u5931\u8D25\uFF0C\u8BF7\u7A0D\u540E\u91CD\u8BD5") {
...
function managementRequestError(cause, operation) {
  ...
  error.details = normalizeWeixinDiagnosticDetails({ operation, stage: "management.request", occurredAt: (/* @__PURE__ */ new Date()).toISOString() });
  return error;
}
function invalidResponse() {
  const error = new Error("DSH \u5FAE\u4FE1\u7BA1\u7406\u63A5\u53E3\u8FD4\u56DE\u4E86\u65E0\u6CD5\u8BC6\u522B\u7684\u54CD\u5E94\uFF0C\u8BF7\u91CD\u65B0\u8BFB\u53D6\u72B6\u6001\u3002");
  error.code = "weixin-management-invalid-response";
  error.details = { stage: "management.request", occurredAt: (/* @__PURE__ */ new Date()).toISOString() };
  return error;
}
function unwrapRpcResult9(result) {
  ...
  if (!result.ok) {
    if (!isRecord7(result.error)) throw invalidResponse();
...
function normalizeBot6(value) {
  ...
  return {
    ...
    lastMessageError: normalizeLastMessageError(value.lastMessageError),
    error: isRecord7(value.error) ? normalizeConnectionError(value.error, "WEIXIN_ACCOUNT_ERROR", "\u5FAE\u4FE1\u8FDE\u63A5\u672A\u5C31\u7EEA") : null
  };
}
function normalizeSnapshot8(value) {
  ...
  return {
    ...
    warnings: Array.isArray(value.warnings) ? value.warnings.filter(isRecord7).slice(0, 8).map((error) => normalizeConnectionError(error)) : [],
    agentPresetCatalog: normalizeAgentPresetCatalog(value.agentPresetCatalog),
    modelCatalog: normalizeModelCatalog(value.modelCatalog)
  };
}
...
var STAGE_LABELS = {
  ...
  "qr.verify": "\u63D0\u4EA4\u914D\u5BF9\u7801",
  "qr.cancel": "\u53D6\u6D88\u7ED1\u5B9A",
  "credential.read": "\u8BFB\u53D6\u767B\u5F55\u51ED\u636E",
  "credential.save": "\u4FDD\u5B58\u767B\u5F55\u51ED\u636E",
  "credential.remove": "\u79FB\u9664\u767B\u5F55\u51ED\u636E",
  "account.save": "\u4FDD\u5B58\u8D26\u53F7\u914D\u7F6E",
  "account.remove": "\u79FB\u9664\u8D26\u53F7\u914D\u7F6E",
  "state.load": "\u8BFB\u53D6\u8D26\u53F7\u72B6\u6001",
  "state.write": "\u4FDD\u5B58\u8D26\u53F7\u72B6\u6001",
  "state.cleanup": "\u6E05\u7406\u8D26\u53F7\u72B6\u6001",
  "workspace.write": "\u4FDD\u5B58\u5DE5\u4F5C\u533A\u8BBE\u7F6E",
  "workspace.cleanup": "\u6E05\u7406\u5DE5\u4F5C\u533A\u8BBE\u7F6E",
  "runtime.prepare": "\u51C6\u5907\u6D88\u606F\u8FDE\u63A5",
  activation: "\u6FC0\u6D3B\u5FAE\u4FE1\u8D26\u53F7",
  "harness.check": "\u68C0\u67E5 DSH \u5BBF\u4E3B",
  "connection.start": "\u542F\u52A8\u5FAE\u4FE1\u8FDE\u63A5",
  "connection.poll": "\u540C\u6B65\u5FAE\u4FE1\u6D88\u606F",
  "connection.stop": "\u505C\u6B62\u5FAE\u4FE1\u8FDE\u63A5",
  "status.read": "\u8BFB\u53D6\u8FDE\u63A5\u72B6\u6001",
  rollback: "\u6062\u590D\u539F\u8D26\u53F7\u72B6\u6001",
  "management.request": "\u8BBF\u95EE DSH \u7BA1\u7406\u63A5\u53E3"
};
function provisioningErrorTitle(error) {
...
function formatWeixinDiagnostic(value) {
  const error = normalizeConnectionError(value);
  const details = error.details ?? {};
  return [
    localizeText(error.message),
    details.hint ? localizeText(details.hint) : null,
    localizeText("\u9519\u8BEF\u7801") + ": " + error.code,
    ...["operation", "stage", "reason", "httpStatus", "providerCode", "resource", "referenceId", "occurredAt", "rollback", "pluginVersion"].filter((field) => details[field] !== void 0).map((field) => `${field}: ${details[field]}`)
  ].filter(Boolean).join("\n");
}
function WeixinConnectionError({ error: value, warning = false }) {
  const error = normalizeConnectionError(value);
  const details = error.details ?? {};
  const [copyState, setCopyState] = React23.useState(null);
  React23.useEffect(() => setCopyState(null), [details.referenceId, error.code, error.message]);
  const copy = async () => {
    try {
  ...
  const fields = [
    ["\u9519\u8BEF\u7801", error.code],
    ["\u5931\u8D25\u9636\u6BB5", localizeText(STAGE_LABELS[details.stage] ?? details.stage ?? "")],
    ["\u5E95\u5C42\u539F\u56E0", details.reason],
    ["HTTP \u72B6\u6001", details.httpStatus],
    ["\u5FAE\u4FE1\u8FD4\u56DE\u7801", details.providerCode],
    ["\u53C2\u8003\u53F7", details.referenceId],
    ...
    h2(
      ...
      h2(
        ...
        ...fields.flatMap(([label, text7]) => [
          ...
          React23.createElement("dd", { key: label, style: { margin: 0, overflowWrap: "anywhere" } }, String(text7))
        ])
      ),
      ...
      copyState === "manual" ? h2(
        ...
        React23.createElement("textarea", {
          readOnly: true,
          value: formatWeixinDiagnostic(error),
          rows: 7,
          "aria-label": localizeText("\u8BCA\u65AD\u4FE1\u606F"),
...
var Button14 = React24.forwardRef(function Button15({ children, kind = "secondary", className = "", ...props }, ref) {
  return h2("button", {
    ...props,
    ref,
    type: "button",
...
function QrPanel4({ provision, now, busy, onRefresh, onCancel }) {
  const [imageFailed, setImageFailed] = React24.useState(false);
  ...
  const duration = Math.max(1, provision.durationMs ?? 5 * 6e4);
  const progress = Math.round(Math.min(1, remaining / duration) * 100);
  React24.useEffect(() => setImageFailed(false), [source]);
  return h2(
    "div",
    { className: "dxw-card dim-surfaceCard" },
    h2(
...
function VerificationPanel({ provision, busy, onSubmit, onCancel }) {
  const [code, setCode] = React24.useState("");
  const valid = /^\d{4,8}$/.test(code);
  React24.useEffect(() => setCode(""), [provision.attemptId]);
  return h2(
    "div",
    { className: "dxw-card dim-surfaceCard" },
    h2(
...
function WeixinSettingsTab({ rpcCall }) {
  const [model, setModel] = React24.useState({
    phase: "loading",
    bots: [],
  ...
  const [busy, setBusy] = React24.useState(false);
  const [busyByBot, setBusyByBot] = React24.useState({});
  const [feedbackByBot, setFeedbackByBot] = React24.useState({});
  const [removeTarget, setRemoveTarget] = React24.useState(null);
  const [notice, setNotice] = React24.useState("");
  const [operationWarnings, setOperationWarnings] = React24.useState([]);
  const [now, setNow] = React24.useState(() => Date.now());
  const addButtonRef = React24.useRef(null);
  ...
  const announce = React24.useCallback((value) => {
    setNotice("");
    scheduleAnimationFrame(() => {
  ...
  const invoke = React24.useCallback(async (endpoint, payload = {}, signal) => {
    let result;
    try {
      result = await rpcCall(endpoint, payload, signal);
    } catch (error) {
      if (signal?.aborted) throw error;
      throw managementRequestError(error, endpoint);
    }
    return unwrapRpcResult9(result);
  }, [rpcCall]);
  const loadStatus = React24.useCallback(async ({
    signal,
    silent = false,
    restoreProvisioning = false
  } = {}) => {
  ...
  const startProvisioning = React24.useCallback(async ({ replace = false } = {}) => {
    setBusy(true);
    try {
      if (replace && provision?.attemptId) {
  ...
  const cancelProvisioning = React24.useCallback(async () => {
    setBusy(true);
    try {
      if (provision?.attemptId && !["failed", "expired", "cancelled"].includes(provision.status)) {
        await invoke(WEIXIN_ENDPOINTS.cancelProvisioning, { attemptId: provision.attemptId });
  ...
  const submitVerification = React24.useCallback(async (verifyCode) => {
  ...
  const setBotBusy = React24.useCallback((botId, value) => {
    setBusyByBot((current) => {
      const next = { ...current };
      if (value) next[botId] = value;
      else delete next[botId];
  ...
  const reconnect = React24.useCallback(async (account) => {
    const snapshotVersion = workspaceFence.beginMutation();
    ...
    try {
      ...
      const feedback = presentError9(error);
      if (mountedRef.current) {
        setFeedbackByBot((current) => ({ ...current, [account.botId]: feedback }));
      }
  ...
  const saveWorkspace = React24.useCallback(async (account, workspace) => {
    const workspaceVersion = workspaceFence.beginMutation();
    setBotBusy(account.botId, "workspace");
    ...
    try {
      ...
      if (mountedRef.current) setFeedbackByBot((current) => ({ ...current, [account.botId]: presentError9(error) }));
      throw error;
    } finally {
      const shouldRefresh = workspaceFence.endMutation();
      if (shouldRefresh && mountedRef.current) void loadStatus({ silent: true });
  ...
  const saveBotSetting = React24.useCallback(async (account, operation, endpoint, payload) => {
    const snapshotVersion = workspaceFence.beginMutation();
    setBotBusy(account.botId, operation);
    setFeedbackByBot((current) => ({ ...current, [account.botId]: null }));
    try {
  ...
  const remove = React24.useCallback(async (account) => {
    const snapshotVersion = workspaceFence.beginMutation();
    ...
    try {
      ...
      const failure = presentError9(error);
...
var Button16 = React25.forwardRef(function Button17({ children, kind = "secondary", className = "", ...props }, ref) {
  return h2("button", {
    ...props,
    ref,
    type: "button",
...
function WhatsappSettingsTab({ rpcCall }) {
  const [model, setModel] = React25.useState({
    phase: "loading",
    bots: [],
    totals: { configured: 0, connected: 0 },
    error: null,
  ...
  const [busy, setBusy] = React25.useState(false);
  const [busyByBot, setBusyByBot] = React25.useState({});
  const [testNoticeByBot, setTestNoticeByBot] = React25.useState({});
  const [removeTarget, setRemoveTarget] = React25.useState(null);
  const [now, setNow] = React25.useState(Date.now());
  const mounted = React25.useRef(true);
  const workspaceFence = useWorkspaceSnapshotFence();
  const addButtonRef = React25.useRef(null);
  React25.useEffect(() => {
    const disposeDingtalk = installDingtalkStyles();
  ...
  const loadStatus = React25.useCallback(async ({ signal, silent = false, restore = false } = {}) => {
    const workspaceVersion = workspaceFence.beginStatus();
    if (workspaceVersion === null) return void 0;
    if (!silent && mounted.current) setModel((current) => ({ ...current, phase: "loading", error: null }));
    try {
  ...
  const startProvisioning = React25.useCallback(async (replace = false) => {
    setBusy(true);
    try {
      if (replace && provision?.attemptId) {
  ...
  const closeProvision = React25.useCallback(async () => {
    setBusy(true);
    try {
  ...
  const botAction = React25.useCallback(async (account, operation, endpoint, payload) => {
    const snapshotVersion = workspaceFence.beginMutation();
    setBusyByBot((current) => ({ ...current, [account.botId]: operation }));
    if (operation === "reconnect") {
      setTestNoticeByBot((current) => {
...
function ScenePolicyEditor({
  ...
  const ownerHelpId = React27.useId();
  const emptyAllowlistHelpId = React27.useId();
...
function AccessPolicySettingsPage({ channel: channel5, account, rpcCall, onSaved }) {
  ...
  const [draft, setDraft] = React27.useState(() => clonePolicy(
    initialPolicy ?? DEFAULT_ACCESS_POLICY
  ));
  const [saving, setSaving] = React27.useState(false);
  const [feedback, setFeedback] = React27.useState(null);
  React27.useEffect(() => {
...
function safeVerificationHref2(value) {
  if (!value) return void 0;
  try {
    const url = new URL(value);
    return url.protocol === "https:" && [
...
function GroupResponseModeEditor({
  ...
  const [authorizing, setAuthorizing] = React28.useState(false);
...
function PermissionFlow({ provision, now, busy, botName, onRetry, onCancel, onClose }) {
  ...
  const qrSource = safeQrSource7(provision.qrCodeDataUrl);
  const href = safeVerificationHref2(provision.verificationUrl);
...
function FeishuGroupSettingsPage({ account, rpcCall }) {
  const [settings, setSettings] = React28.useState(() => groupSettingsFrom(account));
  const [refreshing, setRefreshing] = React28.useState(false);
  const [refreshError, setRefreshError] = React28.useState(null);
  const [provision, setProvision] = React28.useState(null);
  const [provisionBusy, setProvisionBusy] = React28.useState(false);
  const [now, setNow] = React28.useState(() => Date.now());
  ...
  const loadSettings = React28.useCallback(async ({ signal, restoreProvisioning = false } = {}) => {
    ...
    try {
      ...
      if (signal?.aborted || cause?.name === "AbortError" || !mounted.current) return void 0;
      setRefreshError(presentError3(cause));
      return void 0;
    } finally {
  ...
  const saveSetting = React28.useCallback(async (endpoint, payload) => {
    const value = await invoke(endpoint, { botId: account.botId, ...payload });
    applySnapshot(value);
  }, [account.botId, applySnapshot, invoke]);
  const startAuthorization = React28.useCallback(async ({ replace = false } = {}) => {
    if (provisionBusy) return;
    const previousAttemptId = provision?.attemptId;
    setProvisionBusy(true);
    setProvision({ phase: "creating", operation: GROUP_MESSAGE_PERMISSION_OPERATION2, botId: account.botId });
    try {
      if (replace && previousAttemptId) {
        try {
          await invoke(FEISHU_ENDPOINTS.cancelProvisioning, { attemptId: previousAttemptId });
      ...
      const normalized = normalizeProvisioning2(await invoke(
  ...
  React28.useEffect(() => {
    ...
    const timer = timerHost.setTimeout(async () => {
      try {
        ...
        if (result.operation !== GROUP_MESSAGE_PERMISSION_OPERATION2 || result.botId !== account.botId) {
          throw new Error("\u98DE\u4E66\u670D\u52A1\u8FD4\u56DE\u4E86\u4E0D\u5339\u914D\u7684\u6CE8\u518C\u8FDB\u5EA6");
        }
        if (result.status === "connected") {
        ...
        if (result.status === "expired") {
          if (mounted.current) setProvision((current) => current?.attemptId === provision.attemptId ? { ...current, phase: "qr", expired: true } : current);
          return;
        }
        if (mounted.current) {
        ...
        setProvision((current) => current?.attemptId === provision.attemptId ? { ...current, phase: "error", error: presentError3(cause) } : current);
      }
    }, provision.pollIntervalMs ?? 1800);
    return () => {
      controller.abort();
  ...
  const cancelAuthorization = React28.useCallback(async () => {
    ...
    try {
      ...
      if (mounted.current) {
        setProvision((current) => ({ ...current, phase: "error", error: presentError3(cause) }));
      }
    } finally {
      if (mounted.current) setProvisionBusy(false);
    }
  ...
  return h2(
    ...
    h2(PermissionFlow, {
      ...
      onRetry: () => {
        void startAuthorization({ replace: true });
      },
      onCancel: () => {
...
var FEISHU_BOT_SETTINGS_TABS = Object.freeze([
  ...BOT_SETTINGS_TABS,
...
function TargetForm({
  ...
  const [targetId, setTargetId] = React29.useState(initialValue?.targetId ?? "");
  const [name2, setName] = React29.useState(initialValue?.name ?? "");
  const [kind, setKind] = React29.useState(initialKind);
  const [route, setRoute] = React29.useState(initialValue?.route ?? {});
  const [error, setError] = React29.useState(null);
  const [testing, setTesting] = React29.useState(false);
  const [testState, setTestState] = React29.useState(null);
  const currentTarget = () => {
    ...
    phase === "loading" ? h2("div", { className: "dim-targetSuggestionState", "aria-busy": "true" }, "\u6B63\u5728\u8BFB\u53D6\u5DF2\u804A\u4F1A\u8BDD\u2026") : phase === "error" ? h2(
      ...
      h2(
        ...
        suggestions.map((suggestion, index) => {
          ...
          return React29.createElement("option", {
...
function TargetRow({ definition, target, botId, connected, rpcCall, onChanged, onEdit }) {
  const [action, setAction] = React29.useState(null);
  const [testState, setTestState] = React29.useState(null);
  const [syncFeedback, setSyncFeedback] = React29.useState(null);
  const [copyState, setCopyState] = React29.useState(null);
  const [confirmDelete, setConfirmDelete] = React29.useState(false);
  ...
  return h2(
    ...
    h2(
      ...
      h2(
        ...
        React29.createElement("strong", null, target.name || target.targetId),
...
function DeliveryTargetSettingsPage({
  ...
  const [activeTabId, setActiveTabId] = React29.useState(BOT_SETTINGS_TABS[0].id);
  const [phase, setPhase] = React29.useState("loading");
  const [targets, setTargets] = React29.useState([]);
  const [suggestionPhase, setSuggestionPhase] = React29.useState("idle");
  const [suggestions, setSuggestions] = React29.useState([]);
  const [suggestionError, setSuggestionError] = React29.useState(null);
  const [error, setError] = React29.useState(null);
  const [editor, setEditor] = React29.useState(null);
  const [saving, setSaving] = React29.useState(false);
  const [botCopyState, setBotCopyState] = React29.useState(null);
  const [accessPolicy, setAccessPolicy] = React29.useState(account.accessPolicy);
  ...
  const loadTargets = React29.useCallback(async ({ signal, silent = false } = {}) => {
  ...
  const loadSuggestions = React29.useCallback(async () => {
...
var INBOUND_TTL_MAX_HOURS = 8760;
var INTEGER_STRING = /^[+-]?\d+$/;
function normalizeInboundTtlHours(value) {
  let candidate = value;
...
// plugin-src/client/global-settings.js
var GLOBAL_SETTINGS_RPC_CHANNEL = "/dsh-im-settings";
var GLOBAL_SETTINGS_TAB_ID = "global-settings";
var ATTACHMENTS_TAB_ID = "dim-general-settings-tab-attachments";
var ATTACHMENTS_PANEL_ID = "dim-general-settings-panel-attachments";
var GLOBAL_SETTINGS_ENDPOINTS = Object.freeze({
...
function GlobalSettingsPanel({ rpcCall }) {
  ...
  const [ttlInput, setTtlInput] = React30.useState("");
  const [savedTtl, setSavedTtl] = React30.useState(null);
  const [ttlError, setTtlError] = React30.useState(false);
  const [saveError, setSaveError] = React30.useState(null);
  const [saveSucceeded, setSaveSucceeded] = React30.useState(false);
  const [isSaving, setIsSaving] = React30.useState(false);
  const [sweepConfirming, setSweepConfirming] = React30.useState(false);
  const [sweeping, setSweeping] = React30.useState(false);
  const ttlErrorId = React30.useId();
  const ttlHintsId = React30.useId();
  const sweepTriggerId = React30.useId();
  const sweepConfirmId = React30.useId();
  const sweepConfirmTextId = React30.useId();
  const sweepConfirmButtonId = React30.useId();
  const mounted = React30.useRef(true);
  const saving = React30.useRef(false);
  ...
  const loadSettings = React30.useCallback(async ({ signal } = {}) => {
    setPhase("loading");
    setLoadError(null);
    try {
      ...
      h2(
        ...
        h2(
          ...
          h2("input", {
            ...
            "aria-invalid": ttlError ? "true" : void 0,
          ...
          inlineStatus ? h2("p", {
            ...
            "aria-live": inlineStatus.role === "status" ? "polite" : void 0
...
.dim-panel .dim-workspaceTitle { min-width: 0; display: inline-flex; align-items: center; gap: 5px; }
.dim-panel .dim-workspaceHelp { position: relative; display: inline-flex; align-items: center; flex: none; }
.dim-panel .dim-workspaceHelpButton { width: 17px; height: 17px; display: grid; place-items: center; padding: 0; border: 1px solid color-mix(in srgb, #1677ff 28%, var(--dsw-alias-border-l2, #dfe1e5)); border-radius: 50%; color: #1677ff; background: var(--dsw-alias-bg-layer-1, #fff); font: inherit; font-size: 11px; line-height: 1; font-weight: 700; cursor: help; transition: border-color .15s ease, color .15s ease, background .15s ease, box-shadow .15s ease; }
.dim-panel .dim-workspaceHelpButton:hover { border-color: #1677ff; color: #0f5fce; background: color-mix(in srgb, #1677ff 8%, var(--dsw-alias-bg-layer-1, #fff)); }
.dim-panel .dim-workspaceHelpButton:focus-visible { outline: none; border-color: #1677ff; box-shadow: 0 0 0 3px color-mix(in srgb, #1677ff 16%, transparent); }
.dim-panel .dim-workspaceTooltip { position: absolute; top: calc(100% + 7px); left: 0; z-index: 30; width: min(320px, 100vw - 96px); padding: 9px 10px; border: 1px solid var(--dsw-alias-border-l2, #dfe1e5); border-radius: 8px; color: var(--dsw-alias-label-primary, #1f2329); background: var(--dsw-alias-bg-layer-3, #fff); box-shadow: 0 10px 28px rgb(31 35 41 / 16%); font-size: 11px; line-height: 16px; font-weight: 400; overflow-wrap: anywhere; white-space: normal; opacity: 0; visibility: hidden; transform: translateY(-3px); pointer-events: none; transition: opacity .15s ease, transform .15s ease, visibility .15s ease; }
.dim-panel .dim-workspaceHelp:hover .dim-workspaceTooltip, .dim-panel .dim-workspaceHelp:focus-within .dim-workspaceTooltip { opacity: 1; visibility: visible; transform: translateY(0); }
...
/* 会话目录隔离：卡片式布局，视觉风格对齐 Agent Preset（.dim-preset）。 */
.dim-panel .dim-conversationDirectory { min-width: 0; margin-top: 6px; padding: 6px 10px; border: 1px solid var(--dsw-alias-border-l1, #eef0f3); border-radius: 9px; background: var(--dsw-alias-bg-module-platform, #f7f8fa); }
.dim-panel .dim-conversationDirectoryHeader { position: relative; min-width: 0; display: flex; align-items: center; justify-content: space-between; gap: 10px; color: var(--dsw-alias-label-secondary, #646a73); font-size: 12px; line-height: normal; }
.dim-panel .dim-conversationDirectoryTitle { min-width: 0; display: inline-flex; align-items: center; gap: 5px; font-weight: 650; color: var(--dsw-alias-label-primary, #1f2329); }
.dim-panel .dim-conversationDirectoryHelp { position: relative; display: inline-flex; align-items: center; flex: none; }
.dim-panel .dim-conversationDirectoryHelpButton { width: 17px; height: 17px; display: grid; place-items: center; padding: 0; border: 1px solid color-mix(in srgb, #1677ff 28%, var(--dsw-alias-border-l2, #dfe1e5)); border-radius: 50%; color: #1677ff; background: var(--dsw-alias-bg-layer-1, #fff); font: inherit; font-size: 11px; line-height: 1; font-weight: 700; cursor: help; transition: border-color .15s ease, color .15s ease, background .15s ease, box-shadow .15s ease; }
.dim-panel .dim-conversationDirectoryHelpButton:hover { border-color: #1677ff; color: #0f5fce; background: color-mix(in srgb, #1677ff 8%, var(--dsw-alias-bg-layer-1, #fff)); }
.dim-panel .dim-conversationDirectoryHelpButton:focus-visible { outline: none; border-color: #1677ff; box-shadow: 0 0 0 3px color-mix(in srgb, #1677ff 16%, transparent); }
.dim-panel .dim-conversationDirectoryTooltip { position: absolute; top: calc(100% + 7px); left: 0; z-index: 30; width: min(320px, 100vw - 96px); padding: 9px 10px; border: 1px solid var(--dsw-alias-border-l2, #dfe1e5); border-radius: 8px; color: var(--dsw-alias-label-primary, #1f2329); background: var(--dsw-alias-bg-layer-3, #fff); box-shadow: 0 10px 28px rgb(31 35 41 / 16%); font-size: 11px; line-height: 16px; font-weight: 400; overflow-wrap: anywhere; white-space: normal; opacity: 0; visibility: hidden; transform: translateY(-3px); pointer-events: none; transition: opacity .15s ease, transform .15s ease, visibility .15s ease; }
.dim-panel .dim-conversationDirectoryHelp:hover .dim-conversationDirectoryTooltip, .dim-panel .dim-conversationDirectoryHelp:focus-within .dim-conversationDirectoryTooltip { opacity: 1; visibility: visible; transform: translateY(0); }
.dim-panel .dim-conversationDirectory .dim-contextSwitchRow { min-height: 22px; flex: none; }
.dim-panel .dim-conversationDirectoryFields { min-width: 0; display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 6px 10px; margin-top: 6px; }
.dim-panel .dim-conversationDirectoryField { min-width: 0; display: grid; grid-template-columns: max-content minmax(0, 1fr); align-items: center; gap: 8px; color: var(--dsw-alias-label-secondary, #646a73); font-size: 12px; }
.dim-panel .dim-conversationDirectoryField > span { white-space: nowrap; }
.dim-panel .dim-conversationDirectoryField select, .dim-panel .dim-conversationDirectoryField input { min-width: 0; height: 30px; padding: 0 8px; border: 1px solid var(--dsw-alias-border-l2, #dfe1e5); border-radius: 7px; color: var(--dsw-alias-label-primary, #1f2329); background: var(--dsw-alias-bg-layer-1, #fff); font: inherit; font-size: 12px; }
.dim-panel .dim-conversationDirectoryField select:focus-visible, .dim-panel .dim-conversationDirectoryField input:focus-visible { outline: none; border-color: #1677ff; box-shadow: 0 0 0 2px #1677ff26; }
.dim-panel .dim-conversationDirectoryFields + .dim-summary, .dim-panel .dim-summary + .dim-conversationDirectoryFields { margin-top: 6px; }
.dim-panel .dim-conversationDirectory > .dim-summary { margin-top: 6px; color: var(--dsw-alias-label-secondary, #646a73); font-size: 11px; line-height: 16px; font-weight: 400; }
.dim-panel .dim-conversationDirectoryActions { margin-top: 6px; }
@media (max-width: 720px) { .dim-panel .dim-conversationDirectoryFields { grid-template-columns: minmax(0, 1fr); } }
...
.dim-feishuGroupSelect:hover:not(:disabled) { border-color: color-mix(in srgb, var(--dsw-alias-state-business-primary, #3370ff) 42%, var(--dsw-alias-border-l2, #dfe1e5)); }
...
.dim-feishuGroupQrFrame { position: relative; width: 176px; height: 176px; display: grid; place-items: center; padding: 10px; border: 1px solid var(--dsw-alias-border-l2, #dfe1e5); border-radius: 11px; background: #fff; box-shadow: 0 6px 18px rgb(31 35 41 / 7%); }
.dim-feishuGroupQrFrame img { width: 100%; height: 100%; display: block; object-fit: contain; }
.dim-feishuGroupQrFallback { width: 100%; height: 100%; display: grid; place-content: center; justify-items: center; gap: 7px; border-radius: 7px; color: var(--dsw-alias-state-business-primary, #3370ff); background: #f7f9ff; text-align: center; }
...
.dim-feishuGroupQrExpired span { font-size: 13px; line-height: 20px; font-weight: 650; }
...
.dim-feishuGroupProgress { grid-column: 1 / -1; height: 3px; overflow: hidden; border-radius: 99px; background: var(--dsw-alias-bg-module-platform, #f2f3f5); }
...
.dim-generalSettingsHeader h2 { margin: 0; color: var(--dsw-alias-label-primary, #1f2329); font-size: 18px; line-height: 25px; font-weight: 680; }
.dim-generalSettingsTabsBar { min-width: 0; border-bottom: 1px solid var(--dsw-alias-border-l2, #dfe1e5); }
...
.dim-generalSettingsTab { position: relative; min-height: 38px; flex: none; display: inline-flex; align-items: center; justify-content: center; padding: 6px 2px 9px; border: 0; color: var(--dsw-alias-label-secondary, #646a73); background: transparent; font: inherit; font-size: 13px; line-height: 20px; font-weight: 560; white-space: nowrap; cursor: pointer; transition: color .15s ease; }
...
.dim-generalSettingsTab[aria-selected="true"] { color: var(--dim-blue); font-weight: 650; }
.dim-generalSettingsTab[aria-selected="true"]::after { background: var(--dim-blue); transform: scaleX(1); }
...
.dim-globalTtlTooltip { position: absolute; top: calc(100% + 7px); left: 0; z-index: 30; width: max-content; max-width: min(280px, calc(100vw - 48px)); padding: 9px 10px; border: 1px solid var(--dsw-alias-border-l2, #dfe1e5); border-radius: 8px; background: var(--dsw-alias-bg-layer-3, #fff); box-shadow: 0 10px 28px rgb(31 35 41 / 16%); opacity: 0; visibility: hidden; transform: translateY(-3px); pointer-events: none; transition: opacity .15s ease, transform .15s ease, visibility .15s ease; }
...
.dim-globalTtlHints code { flex: none; min-width: 44px; padding: 0 6px; border-radius: 5px; color: var(--dsw-alias-label-primary, #1f2329); background: var(--dsw-alias-bg-module-platform, #f7f8fa); font: 10px/16px ui-monospace, SFMono-Regular, Menlo, monospace; text-align: center; }
...
.dim-globalTtlInput { width: min(160px, 100%); min-width: 110px; max-width: 160px; flex: 1 1 130px; height: 34px; padding: 0 11px; border: 1px solid var(--dsw-alias-border-l2, #dfe1e5); border-radius: 8px; color: var(--dsw-alias-label-primary, #1f2329); background: var(--dsw-alias-bg-layer-1, #fff); font: 13px ui-monospace, SFMono-Regular, Menlo, monospace; transition: border-color .16s ease, box-shadow .16s ease; }
.dim-globalTtlInput:hover:not(:disabled) { border-color: var(--dsw-alias-border-l3, #bbbfc4); }
.dim-globalTtlInput:focus { outline: none; border-color: var(--dim-blue); box-shadow: 0 0 0 3px color-mix(in srgb, var(--dim-blue) 14%, transparent); }
...
.dim-globalTtlInput:disabled { cursor: not-allowed; opacity: .55; }
...
.dim-globalSweepConfirm { position: absolute; top: calc(100% + 8px); right: 0; z-index: 35; width: 218px; padding: 11px 12px; border: 1px solid var(--dsw-alias-border-l2, #dfe1e5); border-radius: 9px; background: var(--dsw-alias-bg-layer-3, #fff); box-shadow: 0 12px 30px rgb(31 35 41 / 18%); }
...
.dim-deliveryButton.dim-globalSweepConfirmButton { border-color: var(--dsw-alias-state-error-primary, #d54941); color: #fff; background: var(--dsw-alias-state-error-primary, #d54941); }
...
function ManualUpdateCommand({ command, disabled, sourceInstall, desktop }) {
  const [copyState, setCopyState] = React31.useState("idle");
  const commandRef = React31.useRef(null);
  const mounted = React31.useRef(false);
  const copying = React31.useRef(false);
  React31.useEffect(() => {
    mounted.current = true;
    return () => {
      mounted.current = false;
...
function UpdateDialog({ children, onClose }) {
  const dialogRef = React31.useRef(null);
...
function UpdatePanel({ rpcCall, clientVersion, onStatus }) {
  const [snapshot, setSnapshot] = React31.useState(null);
  const [action, setAction] = React31.useState("status");
  const [error, setError] = React31.useState(null);
  const [open, setOpen] = React31.useState(false);
  const [uncertainInstall, setUncertainInstall] = React31.useState(false);
  const mounted = React31.useRef(false);
  const busy = React31.useRef(false);
  const readController = React31.useRef(null);
  const pollReadController = React31.useRef(null);
  const installRequest = React31.useRef(null);
  const onStatusRef = React31.useRef(onStatus);
  onStatusRef.current = onStatus;
  const accept = React31.useCallback((next) => {
    setSnapshot(next);
...
function IMSettingsTab({
  ...
  const [selected, setSelected] = React32.useState("weixin");
        ...
        h2(
          ...
          h2(
            ...
            h2("button", {
              ...
              "aria-current": globalSettingsSelected ? "page" : void 0,
              onClick: () => {
